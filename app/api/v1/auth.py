...
async def register(request: RegisterRequest, tenant_id: str = Depends(get_tenant_id)):
    """
    Register a new user
...
async def login(request: LoginRequest, tenant_id: str = Depends(get_tenant_id)):
    """
    Login user
