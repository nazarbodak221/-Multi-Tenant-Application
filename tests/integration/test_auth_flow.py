...
class TestAuthFlow:
    ...
    async def test_register_and_login_core_user(self, core_db, test_client: AsyncClient):
    ...
    async def test_login_wrong_password(self, core_db, core_user, test_client: AsyncClient):
    ...
    async def test_register_duplicate_email(self, core_db, core_user, test_client: AsyncClient):
