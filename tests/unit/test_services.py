...
class TestAuthService:
    ...
    async def test_register_tenant_user(self, mock_token, mock_hash, mock_tortoise, mock_tenant_user, mock_db):
    ...
    @patch('app.services.auth_service.verify_password')
    @patch('app.services.auth_service.create_tenant_token')
    async def test_login_tenant_user(self, mock_token, mock_verify, mock_tortoise, mock_tenant_user, mock_db):
...
class TestUserService:
    ...
    async def test_get_tenant_user_profile(self, mock_tortoise, mock_tenant_user, mock_db):
    ...
    @patch('app.services.user_service.TenantUser')
    @patch('app.services.user_service.Tortoise')
    async def test_update_tenant_user_profile(self, mock_tortoise, mock_tenant_user, mock_db):
...
class TestOrganizationService:
    ...
    async def test_create_organization(self, mock_emitter, mock_db, mock_org_repo_class, mock_user_repo_class):
        ...
        mock_org_repo.get_by_field = AsyncMock(return_value=None)  # No existing org with same name
